...
{   // $contenu .= $_GET['id_produit']
    ...
    $chemin_photo_a_supprimer = $_SERVER['DOCUMENT_ROOT'] . $education_a_supprimer['photo'];
...
if(isset($_GET['action']) && $_GET['action'] == "affichage")
{
    ...
    while ($ligne = $resultat->fetch_assoc())
    {
        ...
        $contenu .= '<td><a href="?action=suppressionExperience&id_produit=' . $ligne['id'] .'" OnClick="return(confirm(\'En êtes vous certain ?\'));"><img src="../inc/img/delete.png"></a></td>';
        $contenu .= '</tr>';
    }
    ...
    while ($ligne = $resultat->fetch_assoc())
    {
        ...
        $contenu .= '<td><a href="?action=suppressionEducation&id_produit=' . $ligne['id'] .'" OnClick="return(confirm(\'En êtes vous certain ?\'));"><img src="../inc/img/delete.png"></a></td>';
        $contenu .= '</tr>';
    }
    $contenu .= '</table><br><hr><br>';
}
